...
<div class="container">
  ...
  <a href="${contextPath}/lottery/rules">Rules and guidelines>>></a>
  </div>
 <form:form class="form-horizontal" action="${contextPath}/user/win" method="post" commandName="payment">
    <div class="form-group">
      <label class="control-label col-sm-2" for="amount">Amount:</label>
      <div class="col-sm-10">
        <label class="control-label col-sm-2" for="amount">1$</label>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Credit card number:</label>
      <div class="col-sm-10">          
	<form:input path="creditCard" size="30" min="0" type="number" class="form-control" placeholder="Enter credit card number"
						 required="required" /> 
      </div>
    </div>
    <div class="form-group">
